...
"""Processor that sets access for a file"""

import os
from autopkglib import Processor, ProcessorError

__all__ = ["FileAccessSetter"]

class FileAccessSetter(Processor):
    """Set access for a file."""
    description = __doc__
    input_variables = {
        "file_path": {
            "required": True,
            "description": "Path to a file to change access.",
        },
        "file_mode": {
            "required": False,
